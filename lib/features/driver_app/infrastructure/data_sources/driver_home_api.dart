...
class DriverHomeApi {
  ...
  static const String _availabilityPath = '/api/booking/v1/worker/availability/';
  static const String _statsPath = '/api/booking/v1/worker/stats/';
  static const String _feedPath = '/api/booking/v1/worker/feed/';
  ...
  Future<AvailabilityModel> getAvailability() async {
    try {
      final response = await _dio.get(_availabilityPath);
  ...
  Future<AvailabilityModel> setAvailability({required bool online}) async {
    try {
  ...
  Future<JobFeedModel> getJobFeed({String? date}) async {
    try {
      final queryParams = <String, dynamic>{};
      ...
      return JobFeedModel.fromJson(response.data);
    } on DioException catch (e) {
      throw _handleError(e);
    }
  }
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) async {
    try {
      ...
      if (sessionData != null) {
        ...
        if (sessionId != null) {
          ...
          if (['POST', 'PUT', 'PATCH', 'DELETE'].contains(options.method)) {
            if (csrfToken != null) {
              ...
              print('   X-CSRFToken sent: $csrfToken');
            } else {
        ...
        print('⚠️ NO SESSION DATA FOUND IN HIVE!');
      }
    } catch (e) {
