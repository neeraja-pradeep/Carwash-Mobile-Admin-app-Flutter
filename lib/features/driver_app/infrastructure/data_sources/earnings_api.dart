...
class EarningsApi {
  ...
  Future<EarningsSummaryModel> getEarningsSummary() async {
    try {
      final response = await _dio.get('/api/booking/v1/worker/earnings/summary/');
      return EarningsSummaryModel.fromJson(response.data as Map<String, dynamic>);
